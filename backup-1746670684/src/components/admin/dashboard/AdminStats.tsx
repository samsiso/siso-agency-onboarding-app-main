  ...
  return (
    <Card className="border border-gray-800">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-medium text-gray-400">Weekly Tasks</h3>
          ...
          <div className="bg-gray-900/50 rounded-lg p-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-gray-200">{formatCompactNumber(stats?.totalLeads || 0)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-900/50 rounded-lg p-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-gray-200">{formatCompactNumber(stats?.totalClients || 0)}</p>
              </div>
            </div>
          </div>
        </div>
