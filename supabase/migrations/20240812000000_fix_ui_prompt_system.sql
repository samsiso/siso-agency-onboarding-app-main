...
-- Insert sample pages for 25 key areas
INSERT INTO public.pages (project_id, name, route, description, priority) VALUES
('ubahcrypt', 'Dashboard', '/dashboard', 'Main trading dashboard with account overview', 1),
('ubahcrypt', 'Market Overview', '/market', 'Market overview with price charts and trends', 2),
('ubahcrypt', 'Trade', '/trade', 'Trading interface for buying and selling crypto', 3),
('ubahcrypt', 'Order History', '/orders', 'History of all completed and pending orders', 4),
('ubahcrypt', 'Wallet', '/wallet', 'Crypto wallet management interface', 5),
('ubahcrypt', 'Assets', '/assets', 'View and manage all crypto assets', 6),
('ubahcrypt', 'Portfolio', '/portfolio', 'Portfolio performance tracking and analysis', 7),
('ubahcrypt', 'Settings', '/settings', 'User account settings and preferences', 8),
('ubahcrypt', 'KYC Verification', '/kyc', 'Know Your Customer verification process', 9),
('ubahcrypt', 'Security', '/security', 'Account security settings and 2FA', 10),
('ubahcrypt', 'Notifications', '/notifications', 'Notification center and preferences', 11),
('ubahcrypt', 'API Management', '/api', 'API key management for developers', 12),
('ubahcrypt', 'Help Center', '/help', 'Support documentation and FAQs', 13),
('ubahcrypt', 'News Feed', '/news', 'Cryptocurrency news and updates', 14),
('ubahcrypt', 'Market Analysis', '/analysis', 'Detailed market analysis tools', 15),
('ubahcrypt', 'Exchange', '/exchange', 'Primary exchange interface', 16),
('ubahcrypt', 'Spot Trading', '/spot', 'Spot trading interface', 17),
('ubahcrypt', 'Futures Trading', '/futures', 'Futures and derivatives trading', 18),
('ubahcrypt', 'Staking', '/staking', 'Staking options for passive income', 19),
('ubahcrypt', 'Earn', '/earn', 'Various earning options including yield farming', 20),
('ubahcrypt', 'NFT Marketplace', '/nft', 'Marketplace for NFT trading', 21),
('ubahcrypt', 'Launchpad', '/launchpad', 'Platform for new token launches', 22),
('ubahcrypt', 'Mobile App QR', '/mobile', 'QR code for mobile app download', 23),
('ubahcrypt', 'Referral Program', '/referral', 'User referral program', 24),
('ubahcrypt', 'Community', '/community', 'Community forum and discussions', 25);

-- Initialize workflow for each page
DO $$
DECLARE
    page_record RECORD;
BEGIN
    FOR page_record IN SELECT id, name, route FROM public.pages LOOP
        PERFORM generate_ui_prompt(
            page_record.id, 
            'analyze_codebase'::ui_prompt_step, 
            'Initial analysis for ' || page_record.name
        );
    END LOOP;
END $$; 