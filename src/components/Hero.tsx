...
export const Hero = () => {
  ...
  return (
    <div className="flex-1 relative">
      ...
      <div className="relative max-w-6xl mx-auto px-3 sm:px-6 py-6 sm:py-8">
        <div className="text-center">
          {/* Welcome Message - Further optimized for mobile */}
          <div className="space-y-3 sm:space-y-6">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-siso-text-bold leading-tight">
              Welcome to{' '}
              <span className="relative block mt-2 sm:mt-4 md:mt-6">
                <span className="relative inline-block p-2 sm:p-3 md:p-4 rounded-lg bg-black/30 backdrop-blur-sm border border-siso-text/10">
                  <span className="relative bg-gradient-to-r from-siso-orange to-siso-red text-transparent bg-clip-text break-words sm:break-normal">
                    SISO Agency Resources
                  </span>
                </span>
              </span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-siso-text max-w-3xl mx-auto leading-relaxed px-2">
            ...
            <div className="mt-4 sm:mt-6 md:mt-8">
              <RainbowButton
                ...
                className="text-sm sm:text-base md:text-lg px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-6 font-semibold"
              >
                Get Started
              </RainbowButton>
            </div>
          ...
          {/* Resource Guide */}
          <div className="mt-4 sm:mt-6 md:mt-8">
            <div className="relative p-3 sm:p-4 md:p-6 rounded-xl bg-black/30 backdrop-blur-sm border border-siso-text/10 
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-siso-text-bold mb-4 sm:mb-6 md:mb-8 bg-gradient-to-r from-siso-orange to-siso-red 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
                {resourceGuideItems.map((item, i) => (
                  <div
                    key={i}
                    className="group p-2 sm:p-3 md:p-4 rounded-lg bg-siso-bg/50 hover:bg-siso-bg/70 
                  ...
                  >
                    <div className="flex items-start gap-2 sm:gap-3">
                      ...
                      <div>
                        <h3 className="text-sm sm:text-base md:text-lg font-semibold text-siso-text-bold mb-1 sm:mb-2">{item.title}</h3>
