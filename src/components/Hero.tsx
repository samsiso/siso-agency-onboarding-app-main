      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-8">
        <div className="text-center">
          ...
          <div className="space-y-4 sm:space-y-6">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-siso-text-bold leading-tight">
              Welcome to{' '}
              <span className="relative inline-block mt-2 sm:mt-0">
                <span className="relative p-2 sm:p-3 md:p-4 rounded-lg bg-black/30 backdrop-blur-sm border border-siso-text/10">
                  <span className="relative bg-gradient-to-r from-siso-orange to-siso-red text-transparent bg-clip-text whitespace-normal sm:whitespace-nowrap">
                    SISO Agency Resources
                  </span>
                </span>
              </span>
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-siso-text max-w-3xl mx-auto leading-relaxed px-2">
            ...
            <div className="mt-6 sm:mt-8">
              <RainbowButton
                ...
                className="text-base sm:text-lg px-8 sm:px-10 py-4 sm:py-6 font-semibold"
              >
                Get Started
              </RainbowButton>
            </div>
          ...
          {/* Resource Guide */}
          <div className="mt-6 sm:mt-8">
            <div className="relative p-4 sm:p-6 rounded-xl bg-black/30 backdrop-blur-sm border border-siso-text/10 
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-siso-text-bold mb-6 sm:mb-8 bg-gradient-to-r from-siso-orange to-siso-red 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                {resourceGuideItems.map((item, i) => (
                  <div
                    key={i}
                    className="group p-3 sm:p-4 rounded-lg bg-siso-bg/50 hover:bg-siso-bg/70 
                  ...
                  >
                    <div className="flex items-start gap-2 sm:gap-3">
                      ...
                      <div>
                        <h3 className="text-base sm:text-lg font-semibold text-siso-text-bold mb-1 sm:mb-2">{item.title}</h3>
