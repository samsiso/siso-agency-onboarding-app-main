    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {featuredItems.map((item, index) => (
          <Card
            key={item.title}
            className={`group relative overflow-hidden rounded-xl bg-gradient-to-br ${item.gradient} border-0 p-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl`}
          >
