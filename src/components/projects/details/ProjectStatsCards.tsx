      ...
      <Card className={`border-0 ${bgColor} shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden h-full`}>
        <div className="p-4 flex flex-col h-full">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className={`h-10 w-10 rounded-full bg-white/5 flex items-center justify-center ${textColor}`}>
              {icon}
            </div>
          </div>
      ...
      <Card className={`border-0 ${bgColor} shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden h-full`}>
        <div className="p-6 flex flex-col h-full">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className={`h-12 w-12 rounded-full bg-white/5 flex items-center justify-center ${textColor} animate-spin-slow`}>
              {icon}
            </div>
          </div>
    ...
    <div className="grid grid-cols-12 gap-4">
      ...
      <div className="col-span-12 md:col-span-3">
        <StatCard 
          ...
          icon={<CheckSquare className="h-5 w-5 text-[#ea384c]" />}
