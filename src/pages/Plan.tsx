  ...
  const detailedPainPoints: PainPointDetailProps[] = isDecoraPlan ? [
    {
      ...
      researchSources: [
        { title: "Creator Economy Report 2023", url: "https://example.com/report", description: "Annual survey of creator management agencies" },
        { title: "OnlyFans Agency Best Practices", url: "https://example.com/best-practices", description: "Industry whitepaper on retention strategies" }
      ]
    },
    {
      problem: "Inefficient Onboarding",
