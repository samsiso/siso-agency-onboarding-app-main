...
// [Analysis] Using explicit storage configuration to ensure consistent session handling
export const supabase = createClient<Database>(
  ...
  SUPABASE_PUBLISHABLE_KEY,
  {
    auth: {
      ...
      persistSession: true,
      storage: localStorage, // Explicitly use localStorage instead of window?.localStorage
      storageKey: 'siso-auth-token', // Add a specific key for the auth token
